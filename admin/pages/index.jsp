            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="overall.jsp"><i class="fa fa-dashboard fa-fw"></i> Overall</a>
                        </li>
                        <li>
                            <a href="transaction.jsp"><i class="fa fa-circle-o-notch fa-spin fa-fw"></i> Unprocessed Transaction</a>
                        </li>
                        <li>
                            <a href="#">
