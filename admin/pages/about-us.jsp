                        ...
                        <table class="table table-bordered table-hover table-striped">
                            <thead class="text-center">
                                <tr>
                                    ...
                                    <th class="col-md-2 text-center">Submenu<a href="#"><i class="fa fa-caret-down pull-right"></a></th>
                                    <th class="col-md-8 text-center">Content<a href="#"><i class="fa fa-caret-down pull-right"></a></th>
