                        ...
                        <table class="table table-bordered table-hover table-striped">
                            <thead class="text-center">
                                <tr>
                                    ...
                                    <th class="col-md-6 text-center">Address<a href="#"><i class="fa fa-caret-down pull-right"></a></th>
                                    <th class="col-md-4 text-center">Phone Number<a href="#"><i class="fa fa-caret-down pull-right"></a></th>
